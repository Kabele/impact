...
<h2>Add Designation Detail</h2>
	...
	<form action="<?php echo site_url('core/c_designation_detail/add/'.$alumni_info->alumni_id); ?>" method="POST" id="designation_detail_add">
		...
		<table class="formtable">
			...
			<tr><td>Organization Address</td><td><textArea rows="5" cols="15" name="organization_address" ></textarea></td></tr>
...
echo "<OPTION value='{$i}'>{$i}</OPTION>";
			...
			<tr><td>&nbsp;</td><td><input type="submit" name="submit" value="Add" class="submitbutton"></td><td><a href="<?php echo site_url('core/c_other_qualification_detail/add/'.$alumni_info->alumni_id);	 ?>">skip</a></td></tr>
		</table>
	</form>
